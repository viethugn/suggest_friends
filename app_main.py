...
def show():
    ...
    # Tạo Treeview
    tree["columns"] = ("ID", "Link", "Name", "Birthday", "Location", "Hometown", "Work", "Thuộc tính chung")
    ...
    for key, values in suggest_friend.items():
        ...
        for value in values:
            ...
            tree.insert("", tk.END, text=str(i), values=(key, value['link'], value['name'], birthday_value, location_value, hometown_value, work_value, value['weight']))
